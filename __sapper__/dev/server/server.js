...
const Q2 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
		...
		<p>${escape(body)}</p> 
		<form class="${"svelte-c95n2i"}"><label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", 0, 0)} selected>
						${escape(browserChoice[0].name)}</label>
				<label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", 1, 0)}>
						${escape(browserChoice[1].name)}</label>
				<label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", 2, 0)}>
						${escape(browserChoice[2].name)}</label>
				<label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", 3, 0)}>
						${escape(browserChoice[3].name)}</label>
				<label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", 4, 0)}>
...
<p>It would be great if your risks began and ended with that theoretical bank. But your personal information is likely all over the connected world — in government offices, at healthcare providers, at stores and restaurants, and in many of your online accounts. You might say it’s everywhere — not literally, but it’s certainly in enough places that it’s out of your control.</p>    
<p>If a cybercriminal accesses that information, it could be off to the races. Your privacy and security could both get trampled.</p>    
<div class="${"button-holder svelte-9jf7df"}"><button class="${"svelte-9jf7df"}">Continue Privacy Challege</button></div>
`
	})}`;
});
...
${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
    ...
    <div class="${"button-holder svelte-9jf7df"}"><button class="${"svelte-9jf7df"}">Continue Challege</button></div>
`
	})}`;
});
...
${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
    ...
    <div class="${"button-holder svelte-9jf7df"}"><button class="${"svelte-9jf7df"}">Continue Challege</button>
...
const css$c = {
	code: "#timer.svelte-1uwstzq{display:flex;flex-direction:column;width:20vw;height:135px}#remaining.svelte-1uwstzq{font-size:20px;padding:5px 0px 20px 0px}#minutes.svelte-1uwstzq{color:white;background:#0F2033;border-radius:6px;width:9.7vw;height:6.7vh;text-align:center;font-size:30px}.done.svelte-1uwstzq{display:flex;flex-flow:row nowrap;align-items:center;margin-bottom:55px;margin-right:40px;height:40px}.lock.svelte-1uwstzq{width:32px;margin:10px}.ellipse.svelte-1uwstzq{width:6px;height:6px;margin:3px}.active.svelte-1uwstzq{opacity:100%\n    }.inactive.svelte-1uwstzq{opacity:30%\n    }",
	map: "{\"version\":3,\"file\":\"Completion.svelte\",\"sources\":[\"Completion.svelte\"],\"sourcesContent\":[\"<script>\\n    let steps= [\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n        { id:'1', status:'active'},\\n    ]\\n\\n    //total time for countdown\\nimport { tweened } from 'svelte/motion';\\nlet start= 30 * 60;\\nlet timer = tweened(start);\\n  setInterval(() => {\\n    if ($timer > 0) $timer--;\\n  }, 1000);\\n\\n  $: minutes = Math.floor($timer / 60);\\n  $: minname = minutes > 1 ? \\\"mins\\\" : \\\"min\\\";\\n  $: seconds = Math.floor($timer - minutes * 60)\\n\\n</script>\\n<section id=\\\"timer\\\">\\n    <span id='remaining'>Time remaining:</span> \\n    <span id='minutes'>{minutes}:{seconds}</span>\\n</section>\\n<section class='done'>\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='active lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse active' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' /> \\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='inactive lock' />\\n</section>\\n<style>\\n    #timer {\\n        display: flex;\\n        flex-direction: column; \\n        width: 20vw;\\n        height: 135px;\\n        /*border-bottom: 1px solid #c7c7c7;*/\\n    }\\n    #remaining {\\n        font-size: 20px;\\n        padding: 5px 0px 20px 0px;\\n        \\n\\n    }\\n    #minutes {\\n        color:white;\\n        background: #0F2033;\\n        border-radius: 6px;\\n        width: 9.7vw;\\n        height: 6.7vh;\\n        text-align: center;\\n        font-size: 30px;\\n        \\n\\n    }\\n    .done {\\n        display: flex;\\n        flex-flow: row nowrap;\\n        align-items: center;\\n        margin-bottom: 55px;\\n        margin-right: 40px;\\n        height: 40px;\\n    }\\n    .lock {\\n        width: 32px;\\n        margin: 10px;\\n    }\\n    .ellipse {\\n        width:6px;\\n        height:6px;\\n        margin: 3px;\\n    }\\n    .active {\\n        opacity: 100%\\n    }\\n    .inactive {\\n        opacity: 30%\\n    }\\n</style>\\n<!--\\n\\n        \\n<div class='done'>\\n    {if active}\\n    <img src='./lock-active.svg' alt=\\\"completed\\\" class='active lock' />\\n    \\n        <img src='./Ellipse-active.png' alt=\\\"completed\\\" class='ellipse active' />\\n        <img src='./Ellipse-inactive.png' alt=\\\"completed\\\" class='ellipse inactive' />\\n</div>\\n</div>-->\"],\"names\":[],\"mappings\":\"AA4DI,MAAM,eAAC,CAAC,AACJ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,AAEjB,CAAC,AACD,UAAU,eAAC,CAAC,AACR,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,GAAG,CAAC,GAAG,CAAC,IAAI,CAAC,GAAG,AAG7B,CAAC,AACD,QAAQ,eAAC,CAAC,AACN,MAAM,KAAK,CACX,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,GAAG,CAClB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,UAAU,CAAE,MAAM,CAClB,SAAS,CAAE,IAAI,AAGnB,CAAC,AACD,KAAK,eAAC,CAAC,AACH,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,GAAG,CAAC,MAAM,CACrB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,IAAI,CACnB,YAAY,CAAE,IAAI,CAClB,MAAM,CAAE,IAAI,AAChB,CAAC,AACD,KAAK,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AACD,QAAQ,eAAC,CAAC,AACN,MAAM,GAAG,CACT,OAAO,GAAG,CACV,MAAM,CAAE,GAAG,AACf,CAAC,AACD,OAAO,eAAC,CAAC,AACL,OAAO,CAAE,IAAI;IACjB,CAAC,AACD,SAAS,eAAC,CAAC,AACP,OAAO,CAAE,GAAG;IAChB,CAAC\"}"
};
...
const Completion = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section id="${"timer"}" class="${"svelte-1uwstzq"}"><span id="${"remaining"}" class="${"svelte-1uwstzq"}">Time remaining:</span> 
    <span id="${"minutes"}" class="${"svelte-1uwstzq"}">${escape(minutes)}:${escape(seconds)}</span></section>
<section class="${"done svelte-1uwstzq"}"><img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"active lock svelte-1uwstzq"}">
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse active svelte-1uwstzq"}">
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">
    <img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"inactive lock svelte-1uwstzq"}">
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">
    <img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"inactive lock svelte-1uwstzq"}"> 
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">
    <img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"inactive lock svelte-1uwstzq"}">
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-1uwstzq"}">
    ...
    <img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"inactive lock svelte-1uwstzq"}"></section>
