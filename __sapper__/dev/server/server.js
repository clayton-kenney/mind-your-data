...
<main class="${"svelte-29bjxa"}">${showSideBar
	? `${validate_component(Completion, "Completion").$$render($$result, { class: "step" }, {}, {
			default: () => `${escape(quizStep[$count].name)}`
		})}
       <div id="${"main-content"}" class="${"svelte-29bjxa"}">${validate_component(quizStep[$count].component || missing_component, "svelte:component").$$render($$result, {}, {}, {})}</div>`
	: `<div id="${"checkpoint"}" class="${"svelte-29bjxa"}">${validate_component(quizStep[$count].component || missing_component, "svelte:component").$$render($$result, {}, {}, {})}</div>`}
...
${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
		default: () => `<section class="${"review svelte-tqdeu8"}">${$step === 0
		? `<h2>You have completed ${escape(comp)} / 8 challenges!</h2>
    
    ${each($quizSteps, ({ name, complete, displayProgress }) => `${displayProgress
			? `<div class="${["caret svelte-tqdeu8", complete ? "complete" : ""].join(" ").trim()}"><p class="${["status svelte-tqdeu8", complete ? "complete" : ""].join(" ").trim()}">${escape(name)}</p>
        ${!complete
				...
				: `<svg width="${"21"}" height="${"21"}" viewBox="${"0 0 21 21"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M10.2754 19.037C15.1206 19.037 19.0509 15.1126 19.0509 10.2685C19.0509 5.42444 15.1206 1.5 10.2754 1.5C5.43025 1.5 1.5 5.42444 1.5 10.2685C1.5 15.1126 5.43025 19.037 10.2754 19.037Z"}" fill="${"#E94040"}" stroke="${"#E94040"}" stroke-width="${"3"}"></path><path d="${"M8.28453 15.8272L3.87075 11.4176C3.60558 11.1527 3.60558 10.7232 3.87075 10.4583L4.83104 9.49886C5.09621 9.23391 5.52618 9.23391 5.79135 9.49886L8.76468 12.4693L15.1332 6.10689C15.3984 5.84197 15.8284 5.84197 16.0935 6.10689L17.0538 7.06629C17.319 7.3312 17.319 7.76074 17.0538 8.02568L9.24484 15.8272C8.97964 16.0921 8.5497 16.0921 8.28453 15.8272Z"}" fill="${"#303538"}"></path></svg>`}
    </div>`
			: ``}`)}
    <div class="${"button-holder svelte-tqdeu8"}">${validate_component(Btn, "Btn").$$render($$result, { p: 0, q: s }, {}, { default: () => `Claim my Prize` })}
        <a prefetch href="${"quizmain"}"><button class="${"svelte-tqdeu8"}">Back to quiz</button></a></div>`
		: `${$step === 1
			? `<div class="${"prize1 svelte-tqdeu8"}"><h3>Congrats!</h3>
            <p>You didn&#39;t abandon us</p>
        <h1>Level1</h1>
        <h2>Maybe try harder next time...</h2>
        <img src="${"poster_mock.jpg"}" alt="${"mind your data poster on the street at night"}" class="${"svelte-tqdeu8"}">
            <p>Prize: A radical mind your data poster. <br>Download it, and print it at home.</p>
        <div class="${"button-holder svelte-tqdeu8"}"><a href="${"./MindYourDataPoster.pdf"}" download="${""}">${validate_component(Btn, "Btn").$$render($$result, { q: 0, p: 0 }, {}, { default: () => `Download the poster` })}</a></div></div>`
			: `${$step === 2
				? `<div class="${"prize1 svelte-tqdeu8"}"><h3>Congrats!</h3>
            <p>You didn&#39;t abandon us, and learned a little about data privacy</p>
        <h1>Level 2</h1>
        <h2>Not too shabby</h2>
        <img src="${"./pins.jpg"}" alt="${"women wearing mind your data pins which is the prize for this level"}" class="${"svelte-tqdeu8"}">
            <p>Prize: Mind your data pin set. Availible for purchase only for a select group of people.(coming soon)</p>
            
        <div class="${"button-holder svelte-tqdeu8"}">${validate_component(Btn, "Btn").$$render($$result, { q: 0, p: 0, disabled: true }, {}, {
        ...
        <h2>Thanks for caring</h2>
            <p>Prize: Access to a super limited editon Mind Your Data T-shirt. Only 50 made, for those dedicated to privacy.</p>
        <img src="${"./shirt_mock.jpg"}" alt="${"mind your data shirt on a model"}" class="${"svelte-tqdeu8"}">
        <div class="${"button-holder svelte-tqdeu8"}">${validate_component(Btn, "Btn").$$render($$result, { q: 0, p: 0 }, {}, {
...
<main class="${"svelte-11rukd4"}">${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
        ...
        <p class="${"svelte-11rukd4"}">Only for educational purpose, this test will utilize blah blah blah. There will be no personal data collected or shared... This test will only  blah blah blah and utilize blah blah blah. There will be no data... This test will only do blah blah blah and utilize blah blah blah. There will be no data... This test will only do blah blah blah and utilize blah blah blah. There will be no data... </p>
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1fqlyd7"}"><a href="${"/home"}" class="${"svelte-1fqlyd7"}"><img src="${"./MYDlogo_nav.png"}" alt="${"Mind your Data logo"}" class="${"svelte-1fqlyd7"}"></a>
	<ul id="${"navigation"}" class="${"svelte-1fqlyd7"}"><li class="${"svelte-1fqlyd7"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-1fqlyd7"}">home</a></li>
		<li class="${"svelte-1fqlyd7"}"><a${add_attribute("aria-current", segment === "quiz" ? "page" : undefined, 0)} href="${"quiz"}" class="${"svelte-1fqlyd7"}">quiz</a></li>
		<li class="${"svelte-1fqlyd7"}"><a${add_attribute("aria-current", segment === "about" ? "page" : undefined, 0)} href="${"about"}" class="${"svelte-1fqlyd7"}">about</a></li>
