...
<h2>This test contains 10 unique privacy tests that will take you about 30 minutes to complete. Throught the test, we will provide...</h2>
<div class="${"svelte-m0bqhn"}">${each(quizSteps, ({ id, name, time, description }, i) => `<div class="${"num svelte-m0bqhn"}">${escape(i)}${escape(name)} (${escape(time)})</div><div class="${["svelte-m0bqhn",  "active" ].join(" ").trim()}">${escape(description)}</div>`)}
</div>`;
});
...
const Completion = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section id="${"timer"}" class="${"svelte-99wito"}"><span id="${"remaining"}" class="${"svelte-99wito"}">Time remaining:</span> 
    <span id="${"minutes"}" class="${"svelte-99wito"}">${escape(minutes)}:${escape(seconds)}</span></section>
<section class="${"done svelte-99wito"}"><img src="${"./lock-active.svg"}" alt="${"completed"}" class="${"active lock svelte-99wito"}">
        <img src="${"./Ellipse-active.png"}" alt="${"completed"}" class="${"ellipse active svelte-99wito"}">
        <img src="${"./Ellipse-inactive.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-99wito"}">
    <img src="${"./lock-inactive.svg"}" alt="${"completed"}" class="${"inactive lock svelte-99wito"}">
        <img src="${"./Ellipse-inactive.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-99wito"}">
        <img src="${"./Ellipse-inactive.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-99wito"}">
    <img src="${"./lock-inactive.svg"}" alt="${"completed"}" class="${"inactive lock svelte-99wito"}"> 
        <img src="${"./Ellipse-inactive.png"}" alt="${"completed"}" class="${"ellipse inactive svelte-99wito"}">
    ...
    <img src="${"./lock-inactive.svg"}" alt="${"completed"}" class="${"inactive lock svelte-99wito"}"></section>
...
const Q2 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<section id="${"progress"}" class="${"svelte-c95n2i"}"><h3>Search Engine ${escape(fraction)}</h3>
		<ul class="${"svelte-c95n2i"}">${each(q1Steps, step => `<li class="${escape(null_to_empty(step.classn)) + " svelte-c95n2i"}">${escape(step.name)}</li>`)}</ul></section>
	<div class="${"quiz-holder svelte-c95n2i"}">${ `<h1>${escape(headline)}</h1>
		<p>${escape(body)}</p> 
		<form class="${"svelte-c95n2i"}">${each(browserChoice, (browsers, index) => `<label class="${"svelte-c95n2i"}"><input type="${"radio"}"${add_attribute("value", index, 0)}>
						${escape(browsers.name)}
				</label>`)}</form>
		<section id="${"next-skip"}"><button class="${"btn-dark svelte-c95n2i"}">Submit</button></section>`
	}
...
const Q3 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `${($$result.title = `<title>Http Everywhere</title>`, "")}`, "")}
<h2>Http Everywhere</h2> 
<p>Many websites offer encryption. With HTTPS, people running the network between your device and the server hosting the website you’re browsing can’t see your requests and your internet traffic. But some websites still load unencrypted pages by default (HTTP), which also causes a security risk. The EFF has developed a browser extension that makes sure that you access all websites that offer HTTPS using… HTTPS.</p>`;
});
...
<main class="${"svelte-g0hp58"}">${validate_component(Completion, "Completion").$$render($$result, { class: "step" }, {}, {})}
        ${validate_component(quizSteps[quizNum].component || missing_component, "svelte:component").$$render($$result, {}, {}, {})}
...
There will be no personal data collected or shared... 
This test will only  blah blah blah and utilize blah blah blah. 
</p><h2>this should get converted into a modal</h2>
