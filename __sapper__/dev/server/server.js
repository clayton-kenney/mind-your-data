...
<canvas id="${"output"}" class="${"svelte-1og6ztb"}"${add_attribute("this", canvas, 1)}></canvas>`;
});
...
const css$4 = {
	code: "button.svelte-1ip8e9i{margin-top:7.2vh}.green.svelte-1ip8e9i{background-color:#73ef7b;color:#2C3C4E}.yellow.svelte-1ip8e9i{background-color:#F1C330;color:#2C3C4E}.red.svelte-1ip8e9i{background-color:#E74E45;color:#FFFFFF}",
	map: "{\"version\":3,\"file\":\"Btn.svelte\",\"sources\":[\"Btn.svelte\"],\"sourcesContent\":[\"<script>\\n    import { step, progress } from '../store.js'\\n    export let q =1;\\n    export let p = 7.6;\\n    export let green = false;\\n    export let yellow = false;\\n    export let red = false;\\n   const increase = () => {\\n       step.update(n => n+= q);\\n      progress.update(n => n += p)};\\n</script>\\n<button on:click={increase} class:green class:yellow class:red>\\n    <slot>\\n\\n    </slot>\\n</button>\\n\\n<style>\\n    button{\\n        margin-top: 7.2vh;\\n    }\\n    .green {\\n        background-color: #73ef7b;\\n        color: #2C3C4E;\\n    }\\n    .yellow {\\n        background-color: #F1C330;\\n        color: #2C3C4E;\\n    }\\n    .red {\\n        background-color: #E74E45;\\n        color: #FFFFFF;\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAkBI,qBAAM,CAAC,AACH,UAAU,CAAE,KAAK,AACrB,CAAC,AACD,MAAM,eAAC,CAAC,AACJ,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,AAClB,CAAC,AACD,OAAO,eAAC,CAAC,AACL,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,AAClB,CAAC,AACD,IAAI,eAAC,CAAC,AACF,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,OAAO,AAClB,CAAC\"}"
};
...
<main class="${"svelte-fltwt6"}">${showSideBar
	? `${validate_component(Completion, "Completion").$$render($$result, {}, {}, {
...
<main class="${"svelte-xtf1j9"}">${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
		default: () => `${ `<section class="${"svelte-xtf1j9"}"><h1 id="${"welcome"}" class="${"svelte-xtf1j9"}">Welcome to the Mind Your Data Challenge</h1>
        <p class="${"welcome-text svelte-xtf1j9"}">This module is designed to educate visitors about the implications of surveillance capitalism, empower them to take control over their own data, and equip them with tools to make change and opt use. </p>
        <p class="${"welcome-text svelte-xtf1j9"}">Use of this site is at your own risk. If you don&#39;t know what something means, or does, skip it.</p>
        <button id="${"start-challenge"}" class="${"svelte-xtf1j9"}">Start Challenge</button></section>`
		}`
	})}
    </main>`;
});
