...
${validate_component(TransHelp, "Trans").$$render($$result, {}, {}, {
	...
	<hr>
	<div${add_classes([ ""].join(" ").trim())}><div class="${"caret svelte-b0zxsu"}"><svg width="${"24"}" height="${"24"}" viewBox="${"0 0 24 24"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M18.885 7L12 13.7989L5.115 7L3 9.09312L12 18L21 9.09312L18.885 7Z"}" fill="${"white"}"></path></svg>
		<p>Apple Siri</p></div>
		${ ``}</div>
