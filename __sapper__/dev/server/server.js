...
const Completion = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	].join(" ").trim()}"><section id="${"timer"}" class="${"svelte-12ya4j5"}"><div>Time Remaining:</div> <div id="${"minutes"}" style="${"white-space:nowrap;"}" class="${"svelte-12ya4j5"}">${escape(minutes)}:${escape(seconds)}</div> 
       <div id="${"challenge-name"}" class="${"svelte-12ya4j5"}">${$$slots.default
	? $$slots.default({})
	: `

        `}</div></section>
    <div id="${"progress-holder"}" class="${"svelte-12ya4j5"}"><section class="${"done svelte-12ya4j5"}">${each($quizSteps, challenge => `${challenge.type != "checkpoint"
...
<main class="${"svelte-rizrzd"}">${showSideBar
