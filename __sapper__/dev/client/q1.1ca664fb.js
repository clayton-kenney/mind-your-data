...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 82, 4, 2917);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 66, 1, 2056);
			add_location(p, file, 67, 1, 2084);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file, 69, 8, 2321);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file, 70, 8, 2378);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file, 68, 1, 2285);
			add_location(section, file, 65, 0, 2045);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 60, 1, 1505);
			add_location(br, file, 61, 122, 1661);
			add_location(p, file, 61, 1, 1540);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file, 62, 1, 1973);
			add_location(section, file, 59, 0, 1494);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
