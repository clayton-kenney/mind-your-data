...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 43, 1, 1877);
			add_location(p, file, 44, 1, 1923);
			add_location(section, file, 42, 0, 1866);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 47, 1, 2210);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 48, 1, 2251);
			attr_dev(button2, "class", "svelte-9jf7df");
			add_location(button2, file, 49, 1, 2285);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 46, 0, 2181);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 34, 1, 736);
			add_location(p0, file, 35, 2, 765);
			add_location(p1, file, 37, 2, 1219);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 39, 2, 1789);
			add_location(section, file, 33, 0, 725);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
