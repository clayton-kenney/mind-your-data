...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*bg*/ 1 && aside_class_value !== (aside_class_value = "" + (null_to_empty(/*bg*/ ctx[0]) + " svelte-192bj8k"))) {
