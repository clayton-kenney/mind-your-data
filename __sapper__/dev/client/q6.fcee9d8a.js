...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div3, file, 43, 2, 2244);
			attr_dev(div4, "class", "button-holder svelte-h4ab6b");
			add_location(div4, file, 54, 1, 2837);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(iframe, "allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture");
			iframe.allowFullscreen = true;
			add_location(iframe, file, 51, 3, 2567);
		},
		m: function mount(target, anchor) {
			insert_dev(target, iframe, anchor);
		},
