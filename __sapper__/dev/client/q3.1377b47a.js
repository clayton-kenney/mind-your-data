...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p1, file, 34, 3, 1874);
			toggle_class(div0, "active", /*current*/ ctx[0] === "mac");
			add_location(div0, file, 33, 2, 1795);
			add_location(hr0, file, 43, 2, 2161);
			add_location(p2, file, 45, 3, 2246);
			add_location(p3, file, 45, 51, 2294);
			toggle_class(div1, "active", /*current*/ ctx[0] === "pc");
			add_location(div1, file, 44, 3, 2169);
			add_location(hr1, file, 54, 2, 2609);
			attr_dev(a1, "href", "https://chrome.google.com/webstore/detail/duckduckgo-privacy-essent/bkdgflcldnnnapblkhphbgpggdiikppg");
			attr_dev(a1, "target", "_blank");
			add_location(a1, file, 56, 8, 2630);
			add_location(p4, file, 56, 5, 2627);
			add_location(div2, file, 55, 2, 2616);
			attr_dev(div3, "class", "button-holder");
			add_location(div3, file, 58, 2, 2826);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 37, 5, 1962);
			add_location(li1, file, 38, 5, 2026);
			add_location(li2, file, 39, 5, 2054);
			add_location(ol, file, 36, 4, 1952);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 48, 5, 2335);
			add_location(li1, file, 49, 5, 2403);
			add_location(li2, file, 50, 5, 2461);
			add_location(ol, file, 47, 3, 2325);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ol, anchor);
			append_dev(ol, li0);
...
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(63:3) <Complete success={false}>",
		ctx
	});
