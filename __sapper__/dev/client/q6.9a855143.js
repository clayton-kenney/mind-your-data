...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div, "class", "button-holder svelte-1bewgew");
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(iframe, file, 39, 2, 1979);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(iframe, "allow", "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture");
			iframe.allowFullscreen = true;
			add_location(iframe, file, 50, 3, 2558);
		},
		m: function mount(target, anchor) {
			insert_dev(target, iframe, anchor);
		},
...
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(56:2) <Complete success={false}>",
		ctx
	});
