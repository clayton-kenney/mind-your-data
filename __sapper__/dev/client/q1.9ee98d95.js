...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 7, 0, 143);
		},
...
class Next extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*q*/ ctx[0] === undefined && !("q" in props)) {
			console.warn("<Next> was created without expected prop 'q'");
		}
	}
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file$1, 69, 4, 2707);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 53, 1, 1862);
			add_location(p, file$1, 54, 1, 1890);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file$1, 55, 1, 2091);
			add_location(section, file$1, 52, 0, 1851);
		},
		m: function mount(target, anchor) {
