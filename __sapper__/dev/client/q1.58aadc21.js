...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 52, 1, 2009);
			add_location(p, file$1, 53, 1, 2037);
			attr_dev(div, "class", "button-holder svelte-1ei4p");
			add_location(div, file$1, 54, 1, 2284);
			add_location(section, file$1, 51, 0, 1998);
		},
		m: function mount(target, anchor) {
