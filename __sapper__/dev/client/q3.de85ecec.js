...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 30, 1, 1524);
			add_location(p, file, 31, 1, 1570);
			add_location(section, file, 29, 0, 1513);
			attr_dev(button0, "class", "svelte-bxeuvx");
			add_location(button0, file, 34, 1, 1857);
			attr_dev(button1, "class", "svelte-bxeuvx");
			add_location(button1, file, 35, 1, 1898);
			attr_dev(button2, "class", "svelte-bxeuvx");
			add_location(button2, file, 36, 1, 1932);
			attr_dev(button3, "class", "svelte-bxeuvx");
			add_location(button3, file, 37, 1, 1976);
			attr_dev(div, "class", "button-holder svelte-bxeuvx");
			add_location(div, file, 33, 0, 1828);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button3, "click", complete, false, false, false);
				mounted = true;
			}
		},
		p: noop,
