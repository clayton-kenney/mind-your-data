...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(path1, file, 48, 0, 2596);
			attr_dev(svg1, "width", "24");
			attr_dev(svg1, "height", "24");
			attr_dev(svg1, "viewBox", "0 0 24 24");
			attr_dev(svg1, "fill", "none");
			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
			add_location(svg1, file, 47, 52, 2500);
			add_location(p2, file, 47, 3, 2451);
			toggle_class(div2, "active", /*current*/ ctx[0] === "pc");
			add_location(div2, file, 46, 3, 2374);
			add_location(hr1, file, 58, 2, 3009);
			attr_dev(a1, "href", "https://chrome.google.com/webstore/detail/duckduckgo-privacy-essent/bkdgflcldnnnapblkhphbgpggdiikppg");
			attr_dev(a1, "target", "_blank");
			add_location(a1, file, 60, 8, 3030);
			add_location(p3, file, 60, 5, 3027);
			add_location(div3, file, 59, 2, 3016);
			attr_dev(div4, "class", "button-holder");
			add_location(div4, file, 62, 2, 3226);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 52, 5, 2735);
			add_location(li1, file, 53, 5, 2803);
			add_location(li2, file, 54, 5, 2861);
			add_location(ol, file, 51, 3, 2725);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ol, anchor);
			append_dev(ol, li0);
