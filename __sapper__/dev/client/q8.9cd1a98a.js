...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 82, 2, 3437);
			add_location(p, file, 83, 2, 3457);
			add_location(section, file, 81, 1, 3425);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 34, 2, 1549);
			toggle_class(div0, "active", /*current*/ ctx[0] === "amazon");
			add_location(div0, file, 32, 1, 1464);
			add_location(hr0, file, 45, 1, 2050);
			add_location(p1, file, 48, 2, 2141);
			toggle_class(div1, "active", /*current*/ ctx[0] === "google");
			add_location(div1, file, 46, 1, 2056);
			add_location(hr1, file, 59, 1, 2646);
			add_location(p2, file, 62, 2, 2735);
			toggle_class(div2, "active", /*current*/ ctx[0] === "apple");
			add_location(div2, file, 60, 1, 2652);
			add_location(hr2, file, 73, 1, 3233);
			add_location(h3, file, 75, 2, 3269);
			attr_dev(div3, "class", "button-holder svelte-338bov");
			add_location(div3, file, 74, 1, 3239);
			add_location(section, file, 31, 0, 1453);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 21, 1, 714);
			add_location(p0, file, 22, 1, 766);
			add_location(p1, file, 24, 1, 1025);
			attr_dev(div, "class", "button-holder svelte-338bov");
			add_location(div, file, 25, 1, 1300);
			add_location(section, file, 20, 0, 703);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 37, 3, 1606);
			add_location(li1, file, 38, 3, 1719);
			add_location(li2, file, 39, 3, 1810);
			add_location(li3, file, 40, 3, 1915);
			add_location(ul, file, 36, 2, 1598);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 51, 3, 2202);
			add_location(li1, file, 52, 3, 2315);
			add_location(li2, file, 53, 3, 2406);
			add_location(li3, file, 54, 3, 2511);
			add_location(ul, file, 50, 2, 2194);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 65, 3, 2789);
			add_location(li1, file, 66, 3, 2902);
			add_location(li2, file, 67, 3, 2993);
			add_location(li3, file, 68, 3, 3098);
			add_location(ul, file, 64, 2, 2781);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
