...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div3, "class", "svelte-skquru");
			add_location(div3, file$1, 37, 4, 1119);
