...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 65, 4, 2738);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 50, 1, 1953);
			add_location(p, file, 51, 1, 1981);
			attr_dev(div, "class", "button-holder svelte-1ei4p");
			add_location(div, file, 52, 1, 2182);
			add_location(section, file, 49, 0, 1942);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 44, 1, 1416);
			add_location(br, file, 45, 125, 1575);
			add_location(p, file, 45, 4, 1454);
			add_location(section, file, 43, 0, 1405);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
