import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, k as add_location, l as insert_dev, m as append_dev, K as set_data_dev, n as noop, o as createEventDispatcher, Q as onMount, O as afterUpdate, p as globals, q as query_selector_all, x as transition_out, y as check_outros, z as transition_in, R as add_render_callback, T as create_in_transition, U as create_out_transition, B as group_outros, r as create_component, u as claim_component, j as attr_dev, w as mount_component, V as listen_dev, A as destroy_component, W as run_all } from './client.15514fc7.js';
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 47, 1, 1431);
			add_location(h3, file$1, 50, 2, 1515);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file$1, 51, 2, 1560);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file$1, 52, 2, 1603);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file$1, 49, 1, 1485);
			add_location(section, file$1, 46, 0, 1420);
		},
		m: function mount(target, anchor) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 38, 1, 927);
			add_location(p0, file$1, 39, 1, 971);
			add_location(p1, file$1, 40, 1, 1126);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file$1, 42, 2, 1341);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file$1, 41, 1, 1311);
			add_location(section, file$1, 37, 0, 916);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 34, 0, 785);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t, anchor);
