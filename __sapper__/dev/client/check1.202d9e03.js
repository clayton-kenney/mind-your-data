...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 41, 8, 1078);
			add_location(p0, file, 42, 0, 1125);
			add_location(p1, file, 43, 0, 1269);
			add_location(p2, file, 44, 0, 1483);
			add_location(p3, file, 45, 0, 1704);
			add_location(h2, file, 46, 0, 1974);
			add_location(p4, file, 47, 0, 2035);
			add_location(li0, file, 49, 8, 2335);
			add_location(li1, file, 50, 8, 2523);
			add_location(li2, file, 51, 8, 2806);
			add_location(ul, file, 48, 4, 2322);
			add_location(p5, file, 53, 0, 3118);
			add_location(p6, file, 54, 0, 3506);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 55, 0, 3644);
		},
		m: function mount(target, anchor) {
