...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 11, 0, 249);
		},
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file$1, 84, 4, 2959);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 68, 1, 2098);
			add_location(p, file$1, 69, 1, 2126);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file$1, 71, 8, 2363);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file$1, 72, 8, 2420);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file$1, 70, 1, 2327);
			add_location(section, file$1, 67, 0, 2087);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			h2 = element("h2");
			t2 = text("Is your Webcam Covered?");
			t3 = space();
			p = element("p");
			t4 = text("It’s likely your computer already has a built-in camera, and it’s possible for that camera to be used to spy on you.  ");
			br = element("br");
			t5 = text("  If your webcam for whatever reason has been hacked, the person on the other side can take pictures and video of anything or anyone. No, this isn’t just paranoia–a recent survey conducted by HP found that 10% in the U.S. either know someone whose webcam was hacked or have had their own webcam hacked.");
			t6 = space();
			button = element("button");
			t7 = text("Continue");
			this.h();
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, /*$count*/ ctx[1]);
			h1_nodes.forEach(detach_dev);
			t1 = claim_space(section_nodes);
			h2 = claim_element(section_nodes, "H2", {});
			var h2_nodes = children(h2);
			t2 = claim_text(h2_nodes, "Is your Webcam Covered?");
			h2_nodes.forEach(detach_dev);
			t3 = claim_space(section_nodes);
			p = claim_element(section_nodes, "P", {});
			var p_nodes = children(p);
			t4 = claim_text(p_nodes, "It’s likely your computer already has a built-in camera, and it’s possible for that camera to be used to spy on you.  ");
			br = claim_element(p_nodes, "BR", {});
			t5 = claim_text(p_nodes, "  If your webcam for whatever reason has been hacked, the person on the other side can take pictures and video of anything or anyone. No, this isn’t just paranoia–a recent survey conducted by HP found that 10% in the U.S. either know someone whose webcam was hacked or have had their own webcam hacked.");
			p_nodes.forEach(detach_dev);
			t6 = claim_space(section_nodes);
			button = claim_element(section_nodes, "BUTTON", { class: true });
			var button_nodes = children(button);
			t7 = claim_text(button_nodes, "Continue");
			button_nodes.forEach(detach_dev);
			section_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			add_location(h1, file$1, 61, 4, 1528);
			add_location(h2, file$1, 62, 1, 1547);
			add_location(br, file$1, 63, 122, 1703);
			add_location(p, file$1, 63, 1, 1582);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file$1, 64, 1, 2015);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	return [q, $count, advance, advanceTwo];
}
