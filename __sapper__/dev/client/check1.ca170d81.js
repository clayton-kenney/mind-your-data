...
import { q as quizSteps, c as count, t as timerActive } from './store.75dcc089.js';
import { D as Detect } from './Detect.593bfadc.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 41, 8, 1091);
			add_location(p0, file, 42, 0, 1138);
			add_location(p1, file, 43, 0, 1282);
			add_location(p2, file, 44, 0, 1496);
			add_location(p3, file, 45, 0, 1717);
			add_location(h2, file, 46, 0, 1987);
			add_location(p4, file, 47, 0, 2048);
			add_location(li0, file, 49, 8, 2348);
			add_location(li1, file, 50, 8, 2536);
			add_location(li2, file, 51, 8, 2819);
			add_location(ul, file, 48, 4, 2335);
			add_location(p5, file, 53, 0, 3131);
			add_location(p6, file, 54, 0, 3519);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 55, 0, 3657);
		},
		m: function mount(target, anchor) {
