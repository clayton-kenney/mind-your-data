...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(section, "class", "svelte-rshjg6");
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(main, "class", "svelte-rshjg6");
