...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div3, "class", "svelte-uy3a7n");
			add_location(div3, file$1, 37, 4, 1139);
			attr_dev(aside, "class", "svelte-uy3a7n");
