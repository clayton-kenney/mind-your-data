...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 73, 1, 2682);
			add_location(p0, file, 74, 1, 2732);
			add_location(p1, file, 75, 1, 2794);
			add_location(p2, file, 76, 1, 2850);
			add_location(p3, file, 77, 1, 2895);
			add_location(li0, file, 79, 2, 2952);
			add_location(li1, file, 80, 2, 3020);
			add_location(li2, file, 81, 2, 3124);
			add_location(li3, file, 82, 2, 3395);
			add_location(ul, file, 78, 1, 2945);
			add_location(h3, file, 84, 1, 3491);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 86, 2, 3573);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 87, 2, 3623);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 85, 1, 3543);
			add_location(section, file, 72, 0, 2671);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 54, 1, 1659);
			add_location(p0, file, 55, 1, 1701);
			add_location(p1, file, 56, 1, 1763);
			add_location(p2, file, 57, 1, 1819);
			add_location(p3, file, 58, 1, 1864);
			add_location(li0, file, 60, 2, 1921);
			add_location(li1, file, 61, 2, 1989);
			add_location(li2, file, 62, 2, 2093);
			add_location(li3, file, 63, 2, 2364);
			add_location(ul, file, 59, 1, 1914);
			add_location(h3, file, 65, 1, 2460);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 67, 2, 2542);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 68, 2, 2592);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 66, 1, 2512);
			add_location(section, file, 53, 0, 1648);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 46, 1, 1453);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 48, 2, 1524);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 49, 2, 1566);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 47, 1, 1494);
			add_location(section, file, 45, 0, 1442);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 40, 1, 852);
			add_location(p, file, 41, 2, 882);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 42, 2, 1357);
			add_location(section, file, 39, 0, 841);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
