...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 101, 2, 3680);
			add_location(p, file, 102, 2, 3700);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 103, 3, 3757);
			add_location(section, file, 100, 1, 3668);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 53, 2, 1774);
			toggle_class(div0, "active", /*current*/ ctx[1] === "amazon");
			add_location(div0, file, 51, 1, 1689);
			add_location(hr0, file, 64, 1, 2275);
			add_location(p1, file, 67, 2, 2366);
			toggle_class(div1, "active", /*current*/ ctx[1] === "google");
			add_location(div1, file, 65, 1, 2281);
			add_location(hr1, file, 78, 1, 2871);
			add_location(p2, file, 81, 2, 2960);
			toggle_class(div2, "active", /*current*/ ctx[1] === "apple");
			add_location(div2, file, 79, 1, 2877);
			add_location(hr2, file, 92, 1, 3458);
			add_location(h3, file, 94, 2, 3494);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 95, 2, 3532);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 96, 2, 3582);
			attr_dev(div3, "class", "button-holder svelte-9jf7df");
			add_location(div3, file, 93, 1, 3464);
			add_location(section, file, 50, 0, 1678);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 40, 1, 900);
			add_location(p0, file, 41, 1, 952);
			add_location(p1, file, 43, 1, 1211);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 45, 2, 1516);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 46, 2, 1576);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 44, 1, 1486);
			add_location(section, file, 39, 0, 889);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 56, 3, 1831);
			add_location(li1, file, 57, 3, 1944);
			add_location(li2, file, 58, 3, 2035);
			add_location(li3, file, 59, 3, 2140);
			add_location(ul, file, 55, 2, 1823);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 70, 3, 2427);
			add_location(li1, file, 71, 3, 2540);
			add_location(li2, file, 72, 3, 2631);
			add_location(li3, file, 73, 3, 2736);
			add_location(ul, file, 69, 2, 2419);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 84, 3, 3014);
			add_location(li1, file, 85, 3, 3127);
			add_location(li2, file, 86, 3, 3218);
			add_location(li3, file, 87, 3, 3323);
			add_location(ul, file, 83, 2, 3006);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
