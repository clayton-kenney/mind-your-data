...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 90, 8, 3738);
			add_location(p0, file, 91, 12, 3769);
			add_location(h1, file, 92, 8, 3806);
			add_location(h2, file, 93, 8, 3855);
			add_location(p1, file, 94, 12, 3894);
			attr_dev(div0, "class", "button-holder");
			add_location(div0, file, 96, 8, 3986);
			attr_dev(div1, "id", "prize1");
			attr_dev(div1, "class", "svelte-gymz7e");
			add_location(div1, file, 89, 4, 3712);
		},
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 78, 8, 3366);
			add_location(p0, file, 79, 12, 3398);
			add_location(h1, file, 80, 8, 3435);
			add_location(h2, file, 81, 8, 3459);
			add_location(p1, file, 82, 12, 3496);
			attr_dev(div0, "class", "button-holder");
			add_location(div0, file, 84, 8, 3588);
			attr_dev(div1, "id", "prize1");
			attr_dev(div1, "class", "svelte-gymz7e");
			add_location(div1, file, 77, 4, 3340);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h3);
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 66, 8, 2966);
			add_location(p0, file, 67, 12, 2997);
			add_location(h1, file, 68, 8, 3034);
			add_location(h2, file, 69, 8, 3058);
			add_location(p1, file, 70, 12, 3109);
			attr_dev(div0, "class", "button-holder");
			add_location(div0, file, 72, 8, 3201);
			attr_dev(div1, "id", "prize1");
			attr_dev(div1, "class", "svelte-gymz7e");
			add_location(div1, file, 65, 4, 2940);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, h3);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 39, 4, 1274);
			attr_dev(button, "class", "svelte-gymz7e");
			add_location(button, file, 62, 36, 2864);
			attr_dev(a, "prefetch", "");
			attr_dev(a, "href", "quizmain");
			add_location(a, file, 62, 8, 2836);
			attr_dev(div, "class", "button-holder");
			add_location(div, file, 60, 4, 2755);
		},
		m: function mount(target, anchor) {
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(path0, file, 53, 12, 2051);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(circle, file, 47, 12, 1647);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section, file, 37, 0, 1223);
		},
		m: function mount(target, anchor) {
