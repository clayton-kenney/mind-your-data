...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 33, 1, 1792);
			add_location(p, file, 34, 1, 1838);
			add_location(section, file, 32, 0, 1781);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 37, 1, 2125);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 38, 1, 2166);
			attr_dev(button2, "class", "svelte-9jf7df");
			add_location(button2, file, 39, 1, 2200);
			attr_dev(button3, "class", "svelte-9jf7df");
			add_location(button3, file, 40, 1, 2244);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 36, 0, 2096);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 24, 1, 651);
			add_location(p0, file, 25, 2, 680);
			add_location(p1, file, 27, 2, 1134);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 29, 2, 1704);
			add_location(section, file, 23, 0, 640);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
