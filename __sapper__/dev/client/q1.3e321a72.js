...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 17, 0, 518);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	let target = $quizSteps[$count];
	console.log(target);

	function increment() {
		//quizSteps.set(v => {if (this.id = 1) {this.complete = true} })
		//dispatch('message', {
