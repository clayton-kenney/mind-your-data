...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 73, 1, 2747);
			add_location(p0, file, 74, 1, 2797);
			add_location(p1, file, 75, 1, 2859);
			add_location(p2, file, 76, 1, 2915);
			add_location(p3, file, 77, 1, 2960);
			add_location(li0, file, 79, 2, 3017);
			add_location(li1, file, 80, 2, 3085);
			add_location(li2, file, 81, 2, 3189);
			add_location(li3, file, 82, 2, 3460);
			add_location(ul, file, 78, 1, 3010);
			add_location(h3, file, 84, 1, 3556);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 89, 2, 3679);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 85, 1, 3608);
			add_location(section, file, 72, 0, 2736);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button0, file, 67, 2, 2607);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 68, 2, 2657);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
