...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 94, 2, 3426);
			add_location(p, file, 95, 2, 3446);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 96, 3, 3503);
			add_location(section, file, 93, 1, 3414);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 46, 2, 1520);
			toggle_class(div0, "active", /*current*/ ctx[1] === "amazon");
			add_location(div0, file, 44, 1, 1435);
			add_location(hr0, file, 57, 1, 2021);
			add_location(p1, file, 60, 2, 2112);
			toggle_class(div1, "active", /*current*/ ctx[1] === "google");
			add_location(div1, file, 58, 1, 2027);
			add_location(hr1, file, 71, 1, 2617);
			add_location(p2, file, 74, 2, 2706);
			toggle_class(div2, "active", /*current*/ ctx[1] === "apple");
			add_location(div2, file, 72, 1, 2623);
			add_location(hr2, file, 85, 1, 3204);
			add_location(h3, file, 87, 2, 3240);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 88, 2, 3278);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 89, 2, 3328);
			attr_dev(div3, "class", "button-holder svelte-9jf7df");
			add_location(div3, file, 86, 1, 3210);
			add_location(section, file, 43, 0, 1424);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 49, 3, 1577);
			add_location(li1, file, 50, 3, 1690);
			add_location(li2, file, 51, 3, 1781);
			add_location(li3, file, 52, 3, 1886);
			add_location(ul, file, 48, 2, 1569);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 63, 3, 2173);
			add_location(li1, file, 64, 3, 2286);
			add_location(li2, file, 65, 3, 2377);
			add_location(li3, file, 66, 3, 2482);
			add_location(ul, file, 62, 2, 2165);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 77, 3, 2760);
			add_location(li1, file, 78, 3, 2873);
			add_location(li2, file, 79, 3, 2964);
			add_location(li3, file, 80, 3, 3069);
			add_location(ul, file, 76, 2, 2752);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
