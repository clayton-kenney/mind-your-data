...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 7, 0, 147);
		},
...
class Next extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*num*/ ctx[0] === undefined && !("num" in props)) {
			console.warn("<Next> was created without expected prop 'num'");
		}
	}
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file$1, 70, 4, 2727);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 53, 1, 1864);
			add_location(p, file$1, 54, 1, 1892);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file$1, 55, 1, 2093);
			add_location(section, file$1, 52, 0, 1853);
		},
		m: function mount(target, anchor) {
