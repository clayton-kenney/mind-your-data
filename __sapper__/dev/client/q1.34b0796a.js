...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 14, 0, 433);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function increment() {
		quizSteps[$count].update(this.complete = true);
