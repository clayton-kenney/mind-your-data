...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "caret svelte-jodp0a");
			...
			attr_dev(div2, "class", "caret svelte-jodp0a");
