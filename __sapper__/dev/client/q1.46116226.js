...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 15, 0, 471);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function increment() {
		quizSteps[count].update(a => console.log(a));
