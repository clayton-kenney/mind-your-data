...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(strong2, "class", "svelte-kn6bcb");
			...
			attr_dev(div0, "class", "button-holder svelte-kn6bcb");
			add_location(div0, file, 39, 0, 2807);
			attr_dev(div1, "class", "svelte-kn6bcb");
			add_location(div1, file, 22, 2, 778);
			attr_dev(section, "class", "svelte-kn6bcb");
