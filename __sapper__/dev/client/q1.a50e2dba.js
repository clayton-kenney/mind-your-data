...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 14, 0, 434);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function increment(array) {
		array[$count].update(this.complete = true);
