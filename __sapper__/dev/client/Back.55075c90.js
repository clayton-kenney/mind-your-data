import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, R as validate_store, T as component_subscribe, v as validate_slots, N as empty, n as insert_dev, w as group_outros, b as transition_out, x as check_outros, t as transition_in, j as detach_dev, U as set_store_value, z as create_slot, f as element, g as claim_element, h as children, k as attr_dev, Q as toggle_class, l as add_location, W as listen_dev, A as update_slot, Z as svg_element, C as text, F as claim_text, p as append_dev, G as noop } from './client.1b809048.js';
import { q as quizSteps, c as count, s as step, p as progress } from './store.8b1ed217.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 32, 4, 809);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(button, "yellow", /*yellow*/ ctx[2]);
			toggle_class(button, "red", /*red*/ ctx[3]);
			add_location(button, file, 26, 4, 686);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
...
const file$1 = "src/components/Btn.svelte";
...
class Btn extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { q: 4, p: 5, green: 0, yellow: 1, red: 2 });
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(path, file$2, 23, 4, 712);
			...
			add_location(svg, file$2, 22, 0, 612);
			attr_dev(div, "id", "back");
			attr_dev(div, "class", "svelte-1x5om3e");
			add_location(div, file$2, 19, 0, 536);
		},
		m: function mount(target, anchor) {
