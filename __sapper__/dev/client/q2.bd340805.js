...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 30, 1, 1444);
			add_location(p, file, 31, 1, 1490);
			add_location(section, file, 29, 0, 1433);
			attr_dev(a, "href", "https://www.eff.org/https-everywhere");
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "svelte-18094jg");
			add_location(a, file, 34, 60, 1830);
			button.disabled = /*disabled*/ ctx[1];
			attr_dev(button, "class", "svelte-18094jg");
			add_location(button, file, 34, 1, 1771);
			attr_dev(div, "class", "button-holder svelte-18094jg");
			add_location(div, file, 33, 0, 1742);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*disabled*/ ctx[1] = true, false, false, false);
				mounted = true;
			}
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 20, 1, 710);
			add_location(p0, file, 21, 1, 763);
			add_location(p1, file, 22, 1, 919);
			add_location(p2, file, 23, 1, 1187);
			add_location(section, file, 19, 0, 699);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
