...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 99, 2, 3638);
			add_location(p, file, 100, 2, 3658);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 101, 3, 3715);
			add_location(section, file, 98, 1, 3626);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 51, 2, 1732);
			toggle_class(div0, "active", /*current*/ ctx[1] === "amazon");
			add_location(div0, file, 49, 1, 1647);
			add_location(hr0, file, 62, 1, 2233);
			add_location(p1, file, 65, 2, 2324);
			toggle_class(div1, "active", /*current*/ ctx[1] === "google");
			add_location(div1, file, 63, 1, 2239);
			add_location(hr1, file, 76, 1, 2829);
			add_location(p2, file, 79, 2, 2918);
			toggle_class(div2, "active", /*current*/ ctx[1] === "apple");
			add_location(div2, file, 77, 1, 2835);
			add_location(hr2, file, 90, 1, 3416);
			add_location(h3, file, 92, 2, 3452);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 93, 2, 3490);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 94, 2, 3540);
			attr_dev(div3, "class", "button-holder svelte-9jf7df");
			add_location(div3, file, 91, 1, 3422);
			add_location(section, file, 48, 0, 1636);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 38, 1, 858);
			add_location(p0, file, 39, 1, 910);
			add_location(p1, file, 41, 1, 1169);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 43, 2, 1474);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 44, 2, 1534);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 42, 1, 1444);
			add_location(section, file, 37, 0, 847);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 54, 3, 1789);
			add_location(li1, file, 55, 3, 1902);
			add_location(li2, file, 56, 3, 1993);
			add_location(li3, file, 57, 3, 2098);
			add_location(ul, file, 53, 2, 1781);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 68, 3, 2385);
			add_location(li1, file, 69, 3, 2498);
			add_location(li2, file, 70, 3, 2589);
			add_location(li3, file, 71, 3, 2694);
			add_location(ul, file, 67, 2, 2377);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 82, 3, 2972);
			add_location(li1, file, 83, 3, 3085);
			add_location(li2, file, 84, 3, 3176);
			add_location(li3, file, 85, 3, 3281);
			add_location(ul, file, 81, 2, 2964);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
