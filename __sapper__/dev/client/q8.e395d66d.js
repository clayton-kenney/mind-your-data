import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, o as validate_store, p as component_subscribe, r as createEventDispatcher, U as onMount, v as validate_slots, a as space, x as create_component, q as query_selector_all, b as detach_dev, c as claim_space, y as claim_component, l as insert_dev, z as mount_component, C as transition_in, A as transition_out, F as destroy_component, Q as set_store_value, N as empty, H as group_outros, B as check_outros, e as element, t as text, f as claim_element, g as children, h as claim_text, k as add_location, m as append_dev, _ as toggle_class, j as attr_dev, Y as listen_dev, Z as run_all } from './client.1a9e0d94.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 81, 2, 3388);
			add_location(p, file, 82, 2, 3408);
			add_location(section, file, 80, 1, 3376);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 33, 2, 1500);
			toggle_class(div0, "active", /*current*/ ctx[0] === "amazon");
			add_location(div0, file, 31, 1, 1415);
			add_location(hr0, file, 44, 1, 2001);
			add_location(p1, file, 47, 2, 2092);
			toggle_class(div1, "active", /*current*/ ctx[0] === "google");
			add_location(div1, file, 45, 1, 2007);
			add_location(hr1, file, 58, 1, 2597);
			add_location(p2, file, 61, 2, 2686);
			toggle_class(div2, "active", /*current*/ ctx[0] === "apple");
			add_location(div2, file, 59, 1, 2603);
			add_location(hr2, file, 72, 1, 3184);
			add_location(h3, file, 74, 2, 3220);
			attr_dev(div3, "class", "button-holder svelte-338bov");
			add_location(div3, file, 73, 1, 3190);
			add_location(section, file, 30, 0, 1404);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 20, 1, 665);
			add_location(p0, file, 21, 1, 717);
			add_location(p1, file, 23, 1, 976);
			attr_dev(div, "class", "button-holder svelte-338bov");
			add_location(div, file, 24, 1, 1251);
			add_location(section, file, 19, 0, 654);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 36, 3, 1557);
			add_location(li1, file, 37, 3, 1670);
			add_location(li2, file, 38, 3, 1761);
			add_location(li3, file, 39, 3, 1866);
			add_location(ul, file, 35, 2, 1549);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 50, 3, 2153);
			add_location(li1, file, 51, 3, 2266);
			add_location(li2, file, 52, 3, 2357);
			add_location(li3, file, 53, 3, 2462);
			add_location(ul, file, 49, 2, 2145);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 64, 3, 2740);
			add_location(li1, file, 65, 3, 2853);
			add_location(li2, file, 66, 3, 2944);
			add_location(li3, file, 67, 3, 3049);
			add_location(ul, file, 63, 2, 2732);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(77:2) <Complete success={false}>",
		ctx
	});
