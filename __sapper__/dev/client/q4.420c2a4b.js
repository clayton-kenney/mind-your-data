...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 73, 1, 2738);
			add_location(p0, file, 74, 1, 2788);
			add_location(p1, file, 75, 1, 2850);
			add_location(p2, file, 76, 1, 2906);
			add_location(p3, file, 77, 1, 2951);
			add_location(li0, file, 79, 2, 3008);
			add_location(li1, file, 80, 2, 3076);
			add_location(li2, file, 81, 2, 3180);
			add_location(li3, file, 82, 2, 3451);
			add_location(ul, file, 78, 1, 3001);
			add_location(h3, file, 84, 1, 3547);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 89, 2, 3670);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 85, 1, 3599);
			add_location(section, file, 72, 0, 2727);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 54, 1, 1715);
			add_location(p0, file, 55, 1, 1757);
			add_location(p1, file, 56, 1, 1819);
			add_location(p2, file, 57, 1, 1875);
			add_location(p3, file, 58, 1, 1920);
			add_location(li0, file, 60, 2, 1977);
			add_location(li1, file, 61, 2, 2045);
			add_location(li2, file, 62, 2, 2149);
			add_location(li3, file, 63, 2, 2420);
			add_location(ul, file, 59, 1, 1970);
			add_location(h3, file, 65, 1, 2516);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 67, 2, 2598);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 68, 2, 2648);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 66, 1, 2568);
			add_location(section, file, 53, 0, 1704);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 46, 1, 1509);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 48, 2, 1580);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 49, 2, 1622);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 47, 1, 1550);
			add_location(section, file, 45, 0, 1498);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 40, 1, 908);
			add_location(p, file, 41, 2, 938);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 42, 2, 1413);
			add_location(section, file, 39, 0, 897);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
