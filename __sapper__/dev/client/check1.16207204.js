...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 36, 8, 918);
			add_location(p0, file, 37, 0, 965);
			add_location(p1, file, 38, 0, 1109);
			add_location(p2, file, 39, 0, 1323);
			add_location(p3, file, 40, 0, 1544);
			add_location(h2, file, 41, 0, 1814);
			add_location(p4, file, 42, 0, 1875);
			add_location(li0, file, 44, 8, 2175);
			add_location(li1, file, 45, 8, 2363);
			add_location(li2, file, 46, 8, 2646);
			add_location(ul, file, 43, 4, 2162);
			add_location(p5, file, 48, 0, 2958);
			add_location(p6, file, 49, 0, 3346);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 51, 4, 3516);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 50, 0, 3484);
		},
