...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 87, 4, 2999);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 74, 1, 2215);
			add_location(p, file, 75, 1, 2243);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file, 77, 8, 2480);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file, 78, 8, 2537);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file, 76, 1, 2444);
			add_location(section, file, 73, 0, 2204);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 68, 1, 1664);
			add_location(br, file, 69, 122, 1820);
			add_location(p, file, 69, 1, 1699);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file, 70, 1, 2132);
			add_location(section, file, 67, 0, 1653);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 64, 0, 1522);
		},
		m: function mount(target, anchor) {
