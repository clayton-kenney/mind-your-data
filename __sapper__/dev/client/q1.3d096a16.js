...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 82, 4, 2980);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 66, 1, 2119);
			add_location(p, file, 67, 1, 2147);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file, 69, 8, 2384);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file, 70, 8, 2441);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file, 68, 1, 2348);
			add_location(section, file, 65, 0, 2108);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 60, 1, 1568);
			add_location(br, file, 61, 122, 1724);
			add_location(p, file, 61, 1, 1603);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file, 62, 1, 2036);
			add_location(section, file, 59, 0, 1557);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
