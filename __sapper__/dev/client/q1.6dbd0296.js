...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 65, 4, 2655);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 50, 1, 1897);
			add_location(p, file, 51, 1, 1925);
			attr_dev(div, "class", "button-holder svelte-1ei4p");
			add_location(div, file, 52, 1, 2126);
			add_location(section, file, 49, 0, 1886);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 44, 1, 1361);
			add_location(br, file, 45, 125, 1520);
			add_location(p, file, 45, 4, 1399);
			add_location(section, file, 43, 0, 1350);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
