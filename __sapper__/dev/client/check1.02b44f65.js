...
import { D as Detect } from './Detect.245a1a8a.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 39, 8, 1018);
			add_location(p0, file, 40, 0, 1065);
			add_location(p1, file, 41, 0, 1209);
			add_location(p2, file, 42, 0, 1423);
			add_location(p3, file, 43, 0, 1644);
			add_location(h2, file, 44, 0, 1914);
			add_location(p4, file, 45, 0, 1975);
			add_location(li0, file, 47, 8, 2275);
			add_location(li1, file, 48, 8, 2463);
			add_location(li2, file, 49, 8, 2746);
			add_location(ul, file, 46, 4, 2262);
			add_location(p5, file, 51, 0, 3058);
			add_location(p6, file, 52, 0, 3446);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 53, 0, 3584);
		},
		m: function mount(target, anchor) {
