...
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file, 52, 1, 1370);
			add_location(h3, file, 55, 2, 1452);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 56, 2, 1497);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 57, 2, 1540);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 54, 1, 1422);
