...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 38, 8, 992);
			add_location(p0, file, 39, 0, 1039);
			add_location(p1, file, 40, 0, 1183);
			add_location(p2, file, 41, 0, 1397);
			add_location(p3, file, 42, 0, 1618);
			add_location(h2, file, 43, 0, 1888);
			add_location(p4, file, 44, 0, 1949);
			add_location(li0, file, 46, 8, 2249);
			add_location(li1, file, 47, 8, 2437);
			add_location(li2, file, 48, 8, 2720);
			add_location(ul, file, 45, 4, 2236);
			add_location(p5, file, 50, 0, 3032);
			add_location(p6, file, 51, 0, 3420);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 52, 0, 3558);
		},
		m: function mount(target, anchor) {
