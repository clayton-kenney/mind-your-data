...
function create_if_block$1(ctx) {
	...
	check = new Check({
			props: { active: /*challenge*/ ctx[17].status },
			$$inline: true
		});
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			const check_changes = {};
			if (dirty & /*$quizSteps*/ 32) check_changes.active = /*challenge*/ ctx[17].status;
...
function create_each_block(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*challenge*/ ctx[17].type != "checkpoint" && create_if_block$1(ctx);
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (/*challenge*/ ctx[17].type != "checkpoint") {
				if (if_block) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(aside, file$1, 29, 0, 832);
		},
		m: function mount(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	let $bg1,
		$$unsubscribe_bg1 = noop,
		$$subscribe_bg1 = () => ($$unsubscribe_bg1(), $$unsubscribe_bg1 = subscribe(bg1, $$value => $$invalidate(13, $bg1 = $$value)), bg1);

	let $bg2,
		$$unsubscribe_bg2 = noop,
		$$subscribe_bg2 = () => ($$unsubscribe_bg2(), $$unsubscribe_bg2 = subscribe(bg2, $$value => $$invalidate(14, $bg2 = $$value)), bg2);

	let $bg3,
		$$unsubscribe_bg3 = noop,
		$$subscribe_bg3 = () => ($$unsubscribe_bg3(), $$unsubscribe_bg3 = subscribe(bg3, $$value => $$invalidate(15, $bg3 = $$value)), bg3);
	...
	$$self.$$.on_destroy.push(() => $$unsubscribe_bg1());
	$$self.$$.on_destroy.push(() => $$unsubscribe_bg2());
	$$self.$$.on_destroy.push(() => $$unsubscribe_bg3());
	let start = 30 * 60;
	...
	afterUpdate(() => {
		...
		if ($quizSteps.id > 3) {
			set_store_value(bg1, $bg1 = false);
			set_store_value(bg2, $bg2 = true);
		}

		{
			if ($quizSteps.id > 8) {
				set_store_value(bg2, $bg2 = false);
				set_store_value(bg3, $bg3 = true);
			}
		}
	});
	...
	$$self.$inject_state = $$props => {
		...
		if ("bg1" in $$props) $$subscribe_bg1($$invalidate(2, bg1 = $$props.bg1));
		if ("bg2" in $$props) $$subscribe_bg2($$invalidate(3, bg2 = $$props.bg2));
		if ("bg3" in $$props) $$subscribe_bg3($$invalidate(4, bg3 = $$props.bg3));
	};
	...
	$$self.$$.update = () => {
	 ...
	 $$subscribe_bg1($$invalidate(2, bg1 = true));
	 $$subscribe_bg2($$invalidate(3, bg2 = false));
	 $$subscribe_bg3($$invalidate(4, bg3 = false));
