...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h3, file, 75, 2, 2231);
			attr_dev(ul, "class", "svelte-1tvhnpi");
			add_location(ul, file, 76, 2, 2267);
		},
		m: function mount(target, anchor) {
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 78, 4, 2303);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file, 91, 5, 2549);
			attr_dev(label, "class", "svelte-1tvhnpi");
			add_location(label, file, 90, 4, 2536);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*isActive*/ ctx[1] == false) return create_if_block;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 86, 2, 2442);
			add_location(p, file, 87, 2, 2464);
			attr_dev(form, "class", "svelte-1tvhnpi");
			add_location(form, file, 88, 2, 2481);
			attr_dev(button, "class", "btn-dark svelte-1tvhnpi");
			add_location(button, file, 97, 3, 2689);
			attr_dev(section1, "id", "next-skip");
			add_location(section1, file, 96, 2, 2660);
			attr_dev(div, "class", "quiz-holder svelte-1tvhnpi");
			add_location(div, file, 85, 1, 2414);
		},
		m: function mount(target, anchor) {
