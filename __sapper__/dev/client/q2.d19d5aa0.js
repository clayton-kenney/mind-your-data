...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 45, 1, 1927);
			add_location(p, file, 46, 1, 1973);
			add_location(section, file, 44, 0, 1916);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 49, 1, 2260);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 50, 1, 2301);
			attr_dev(button2, "class", "svelte-9jf7df");
			add_location(button2, file, 51, 1, 2335);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 48, 0, 2231);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 36, 1, 786);
			add_location(p0, file, 37, 2, 815);
			add_location(p1, file, 39, 2, 1269);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 41, 2, 1839);
			add_location(section, file, 35, 0, 775);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
