...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 39, 8, 1042);
			add_location(p0, file, 40, 0, 1089);
			add_location(p1, file, 41, 0, 1233);
			add_location(p2, file, 42, 0, 1447);
			add_location(p3, file, 43, 0, 1668);
			add_location(h2, file, 44, 0, 1938);
			add_location(p4, file, 45, 0, 1999);
			add_location(li0, file, 47, 8, 2299);
			add_location(li1, file, 48, 8, 2487);
			add_location(li2, file, 49, 8, 2770);
			add_location(ul, file, 46, 4, 2286);
			add_location(p5, file, 51, 0, 3082);
			add_location(p6, file, 52, 0, 3470);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 53, 0, 3608);
		},
		m: function mount(target, anchor) {
