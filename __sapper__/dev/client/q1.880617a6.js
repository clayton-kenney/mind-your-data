...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 14, 0, 435);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	function increment() {
		quizSteps.update(n => n[$count].complete = true);
