...
function create_else_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = current === "mac" && create_if_block_2(ctx);
	let if_block1 = current === "pc" && create_if_block_1(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(hr0, file, 49, 2, 2384);
			add_location(p2, file, 52, 3, 2461);
			attr_dev(path1, "d", "M18.885 7L12 13.7989L5.115 7L3 9.09312L12 18L21 9.09312L18.885 7Z");
			attr_dev(path1, "fill", "white");
			add_location(path1, file, 53, 0, 2610);
			attr_dev(svg1, "width", "24");
			attr_dev(svg1, "height", "24");
			attr_dev(svg1, "viewBox", "0 0 24 24");
			attr_dev(svg1, "fill", "none");
			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
			add_location(svg1, file, 52, 56, 2514);
			attr_dev(div2, "class", "caret svelte-hhwisi");
			add_location(div2, file, 51, 3, 2438);
			toggle_class(div3, "pc", /*pc*/ ctx[1]);
			add_location(div3, file, 50, 3, 2392);
			add_location(hr1, file, 63, 2, 3025);
			...
			add_location(a1, file, 65, 8, 3046);
			add_location(p3, file, 65, 5, 3043);
			add_location(div4, file, 64, 2, 3032);
			attr_dev(div5, "class", "button-holder");
			add_location(div5, file, 67, 2, 3242);
		},
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 43, 5, 2185);
			add_location(li1, file, 44, 5, 2249);
			add_location(li2, file, 45, 5, 2277);
			add_location(ol, file, 42, 4, 2175);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 57, 5, 2751);
			add_location(li1, file, 58, 5, 2819);
			add_location(li2, file, 59, 5, 2877);
			add_location(ol, file, 56, 3, 2741);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ol, anchor);
			append_dev(ol, li0);
