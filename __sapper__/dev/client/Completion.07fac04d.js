...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file$1, 29, 8, 866);
			attr_dev(span1, "id", "minutes");
			attr_dev(span1, "class", "svelte-19wr0vz");
			add_location(span1, file$1, 34, 8, 953);
