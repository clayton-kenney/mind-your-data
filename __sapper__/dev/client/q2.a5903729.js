...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 27, 1, 1731);
			add_location(p, file, 28, 1, 1777);
			add_location(section, file, 26, 0, 1720);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 30, 0, 2035);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 18, 1, 613);
			add_location(p0, file, 19, 2, 642);
			add_location(p1, file, 21, 2, 1096);
			add_location(section, file, 17, 0, 602);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
