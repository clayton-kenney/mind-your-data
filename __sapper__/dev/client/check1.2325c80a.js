...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(strong2, "class", "svelte-xthe3j");
			...
			attr_dev(div, "class", "button-holder svelte-xthe3j");
			add_location(div, file, 38, 0, 2799);
			attr_dev(section, "class", "svelte-xthe3j");
