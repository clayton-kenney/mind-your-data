...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 30, 1, 1943);
			add_location(p, file, 31, 1, 1987);
			attr_dev(div, "class", "button-holder svelte-338bov");
			add_location(div, file, 32, 1, 2450);
			add_location(section, file, 29, 0, 1932);
		},
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 18, 1, 588);
			add_location(p0, file, 19, 1, 615);
			add_location(p1, file, 20, 1, 676);
			add_location(p2, file, 21, 1, 997);
			add_location(p3, file, 23, 1, 1297);
			add_location(p4, file, 25, 1, 1642);
			add_location(section, file, 17, 0, 577);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
