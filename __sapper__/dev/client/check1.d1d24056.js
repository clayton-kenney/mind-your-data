...
import { q as quizSteps, c as count, t as timerActive } from './store.dff58bb5.js';
import { D as Detect } from './Detect.2eab55b6.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 42, 8, 1095);
			add_location(p0, file, 43, 0, 1142);
			add_location(p1, file, 44, 0, 1286);
			add_location(p2, file, 45, 0, 1500);
			add_location(p3, file, 46, 0, 1721);
			add_location(h2, file, 47, 0, 1991);
			add_location(p4, file, 48, 0, 2052);
			add_location(li0, file, 50, 8, 2352);
			add_location(li1, file, 51, 8, 2540);
			add_location(li2, file, 52, 8, 2823);
			add_location(ul, file, 49, 4, 2339);
			add_location(p5, file, 54, 0, 3135);
			add_location(p6, file, 55, 0, 3523);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 56, 0, 3661);
		},
		m: function mount(target, anchor) {
