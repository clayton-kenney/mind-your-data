...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 86, 4, 3088);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 70, 1, 2227);
			add_location(p, file, 71, 1, 2255);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file, 73, 8, 2492);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file, 74, 8, 2549);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file, 72, 1, 2456);
			add_location(section, file, 69, 0, 2216);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 64, 1, 1676);
			add_location(br, file, 65, 122, 1832);
			add_location(p, file, 65, 1, 1711);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file, 66, 1, 2144);
			add_location(section, file, 63, 0, 1665);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
