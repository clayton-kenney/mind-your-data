...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 102, 2, 3738);
			add_location(p, file, 103, 2, 3758);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 104, 3, 3815);
			add_location(section, file, 101, 1, 3726);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p0, file, 54, 2, 1832);
			toggle_class(div0, "active", /*current*/ ctx[1] === "amazon");
			add_location(div0, file, 52, 1, 1747);
			add_location(hr0, file, 65, 1, 2333);
			add_location(p1, file, 68, 2, 2424);
			toggle_class(div1, "active", /*current*/ ctx[1] === "google");
			add_location(div1, file, 66, 1, 2339);
			add_location(hr1, file, 79, 1, 2929);
			add_location(p2, file, 82, 2, 3018);
			toggle_class(div2, "active", /*current*/ ctx[1] === "apple");
			add_location(div2, file, 80, 1, 2935);
			add_location(hr2, file, 93, 1, 3516);
			add_location(h3, file, 95, 2, 3552);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 96, 2, 3590);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 97, 2, 3640);
			attr_dev(div3, "class", "button-holder svelte-9jf7df");
			add_location(div3, file, 94, 1, 3522);
			add_location(section, file, 51, 0, 1736);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 41, 1, 958);
			add_location(p0, file, 42, 1, 1010);
			add_location(p1, file, 44, 1, 1269);
			attr_dev(button0, "class", "svelte-9jf7df");
			add_location(button0, file, 46, 2, 1574);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 47, 2, 1634);
			attr_dev(div, "class", "button-holder svelte-9jf7df");
			add_location(div, file, 45, 1, 1544);
			add_location(section, file, 40, 0, 947);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 57, 3, 1889);
			add_location(li1, file, 58, 3, 2002);
			add_location(li2, file, 59, 3, 2093);
			add_location(li3, file, 60, 3, 2198);
			add_location(ul, file, 56, 2, 1881);
		},
		m: function mount(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 71, 3, 2485);
			add_location(li1, file, 72, 3, 2598);
			add_location(li2, file, 73, 3, 2689);
			add_location(li3, file, 74, 3, 2794);
			add_location(ul, file, 70, 2, 2477);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li0, file, 85, 3, 3072);
			add_location(li1, file, 86, 3, 3185);
			add_location(li2, file, 87, 3, 3276);
			add_location(li3, file, 88, 3, 3381);
			add_location(ul, file, 84, 2, 3064);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
