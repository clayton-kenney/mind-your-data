...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p, "class", "svelte-w72brc");
			toggle_class(p, "complete", /*complete*/ ctx[6]);
			add_location(p, file, 27, 8, 1007);
			attr_dev(div, "class", "caret svelte-w72brc");
