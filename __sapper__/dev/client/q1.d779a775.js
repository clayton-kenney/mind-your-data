...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 65, 4, 2717);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 50, 1, 1932);
			add_location(p, file, 51, 1, 1960);
			attr_dev(div, "class", "button-holder svelte-1ei4p");
			add_location(div, file, 52, 1, 2161);
			add_location(section, file, 49, 0, 1921);
		},
		m: function mount(target, anchor) {
