...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(svg, file, 13, 0, 278);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 10, 4, 203);
		},
		m: function mount(target, anchor) {
