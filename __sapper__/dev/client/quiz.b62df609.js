...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 30, 8, 1521);
			add_location(p0, file, 31, 8, 1558);
			add_location(p1, file, 32, 8, 1704);
			attr_dev(a, "rel", "prefetch");
			attr_dev(a, "href", "quizmain");
			add_location(a, file, 33, 27, 1860);
			attr_dev(button, "id", "start");
			attr_dev(button, "class", "svelte-1gme2nj");
			add_location(button, file, 33, 8, 1841);
			attr_dev(section, "class", "svelte-1gme2nj");
			add_location(section, file, 29, 4, 1503);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 20, 8, 855);
			add_location(p_1, file, 21, 8, 908);
			add_location(h2, file, 23, 8, 1331);
			attr_dev(button0, "class", "svelte-1gme2nj");
			add_location(button0, file, 26, 8, 1416);
			attr_dev(button1, "class", "svelte-1gme2nj");
			add_location(button1, file, 24, 8, 1387);
			attr_dev(section, "class", "svelte-1gme2nj");
			add_location(section, file, 19, 4, 837);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h1);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file, 13, 8, 253);
			add_location(p_1, file, 14, 8, 306);
			attr_dev(button, "class", "svelte-1gme2nj");
			add_location(button, file, 16, 8, 729);
			attr_dev(section, "class", "svelte-1gme2nj");
			add_location(section, file, 12, 4, 235);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h1);
