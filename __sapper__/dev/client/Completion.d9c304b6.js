...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			const check_changes = {};
			if (dirty & /*$quizSteps*/ 4) check_changes.active = /*challenge*/ ctx[17].status;
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(aside, "bg1", /*bg1*/ ctx[5]);
			toggle_class(aside, "bg2", /*bg2*/ ctx[6]);
			toggle_class(aside, "bg3", /*bg3*/ ctx[7]);
...
function instance$1($$self, $$props, $$invalidate) {
	...
	let bg1 = true;
	validate_store(bg1, "bg1");
	component_subscribe($$self, bg1, value => $$invalidate(13, $bg1 = value));
	let bg2 = false;
	validate_store(bg2, "bg2");
	component_subscribe($$self, bg2, value => $$invalidate(14, $bg2 = value));
	let bg3 = false;
	validate_store(bg3, "bg3");
	component_subscribe($$self, bg3, value => $$invalidate(15, $bg3 = value));
	...
	$$self.$inject_state = $$props => {
		...
		if ("bg1" in $$props) $$invalidate(5, bg1 = $$props.bg1);
		if ("bg2" in $$props) $$invalidate(6, bg2 = $$props.bg2);
		if ("bg3" in $$props) $$invalidate(7, bg3 = $$props.bg3);
