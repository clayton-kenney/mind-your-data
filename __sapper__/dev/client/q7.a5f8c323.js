...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 102, 2, 3747);
			add_location(p, file, 103, 2, 3767);
			attr_dev(button, "class", "svelte-9jf7df");
			add_location(button, file, 104, 3, 3824);
			add_location(section, file, 101, 1, 3735);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button0, file, 96, 2, 3599);
			attr_dev(button1, "class", "svelte-9jf7df");
			add_location(button1, file, 97, 2, 3649);
