import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, r as createEventDispatcher, T as onMount, U as afterUpdate, v as validate_slots, V as beforeUpdate, W as onDestroy, u as globals, a as space, w as create_component, q as query_selector_all, b as detach_dev, c as claim_space, x as claim_component, l as insert_dev, y as mount_component, B as transition_in, z as transition_out, E as destroy_component, M as empty, G as group_outros, A as check_outros, e as element, f as claim_element, g as children, j as attr_dev, k as add_location, n as noop, t as text, h as claim_text, m as append_dev, X as listen_dev, Y as run_all } from './client.cc2ee86d.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file, 82, 4, 2935);
		},
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 66, 1, 2074);
			add_location(p, file, 67, 1, 2102);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file, 69, 8, 2339);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file, 70, 8, 2396);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file, 68, 1, 2303);
			add_location(section, file, 65, 0, 2063);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 60, 1, 1523);
			add_location(br, file, 61, 122, 1679);
			add_location(p, file, 61, 1, 1558);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file, 62, 1, 1991);
			add_location(section, file, 59, 0, 1512);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
