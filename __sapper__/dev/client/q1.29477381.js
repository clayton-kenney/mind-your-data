import { H as writable, S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, M as create_slot, v as validate_slots, e as element, f as claim_element, g as children, b as detach_dev, k as add_location, l as insert_dev, P as listen_dev, O as update_slot, B as transition_in, z as transition_out, o as validate_store, p as component_subscribe, r as createEventDispatcher, Q as afterUpdate, R as onMount, T as beforeUpdate, U as onDestroy, u as globals, a as space, w as create_component, q as query_selector_all, c as claim_space, x as claim_component, y as mount_component, E as destroy_component, t as text, V as empty, h as claim_text, m as append_dev, F as set_data_dev, G as group_outros, A as check_outros, j as attr_dev, n as noop, W as run_all } from './client.8986eee1.js';
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video_1, file$1, 85, 4, 2960);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 69, 1, 2099);
			add_location(p, file$1, 70, 1, 2127);
			attr_dev(button0, "class", "svelte-1sss75x");
			add_location(button0, file$1, 72, 8, 2364);
			attr_dev(button1, "class", "svelte-1sss75x");
			add_location(button1, file$1, 73, 8, 2421);
			attr_dev(div, "class", "button-holder svelte-1sss75x");
			add_location(div, file$1, 71, 1, 2328);
			add_location(section, file$1, 68, 0, 2088);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file$1, 63, 1, 1548);
			add_location(br, file$1, 64, 122, 1704);
			add_location(p, file$1, 64, 1, 1583);
			attr_dev(button, "class", "svelte-1sss75x");
			add_location(button, file$1, 65, 1, 2016);
			add_location(section, file$1, 62, 0, 1537);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
			append_dev(section, h2);
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$1, 59, 4, 1507);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (!current || dirty & /*$count*/ 2) set_data_dev(t0, /*$count*/ ctx[1]);
